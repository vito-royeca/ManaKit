...
nonisolated public struct SetsByYearQuery: GraphQLQuery {
  public static let operationName: String = "SetsByYear"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query SetsByYear { setsByYear { __typename ...SectionedSets } }"#,
  ...
  nonisolated public struct Data: ManaKit.SelectionSet {
    ...
    @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
      .field("setsByYear", SetsByYear?.self),
    ] }
    @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
      SetsByYearQuery.Data.self
    ] }

    public var setsByYear: SetsByYear? { __data["setsByYear"] }

    /// SetsByYear
    ///
    /// Parent Type: `MGSectionedSets`
    nonisolated public struct SetsByYear: ManaKit.SelectionSet {
      @_spi(Unsafe) public let __data: DataDict
      @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        SetsByYearQuery.Data.SetsByYear.self,
        SectionedSets.self
      ] }
