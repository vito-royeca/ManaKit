...
nonisolated public struct CardsByIDsQuery: GraphQLQuery {
  public static let operationName: String = "CardsByIDs"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query CardsByIDs($ids: [String!]!) { cardsByIDs(ids: $ids) { __typename count cards { __typename ...CardBasicInfo } } }"#,
  ...
  nonisolated public struct Data: ManaKit.SelectionSet {
    ...
    @_spi(Execution) public static var __selections: [ApolloAPI.Selection] { [
      .field("cardsByIDs", CardsByIDs?.self, arguments: ["ids": .variable("ids")]),
    ] }
    @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
      CardsByIDsQuery.Data.self
    ] }

    public var cardsByIDs: CardsByIDs? { __data["cardsByIDs"] }

    /// CardsByIDs
    ///
    /// Parent Type: `MGCards`
    nonisolated public struct CardsByIDs: ManaKit.SelectionSet {
      @_spi(Unsafe) public let __data: DataDict
      @_spi(Unsafe) public init(_dataDict: DataDict) { __data = _dataDict }
      ...
      @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
        CardsByIDsQuery.Data.CardsByIDs.self
      ] }
      ...
      nonisolated public struct Card: ManaKit.SelectionSet {
        ...
        @_spi(Execution) public static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          CardsByIDsQuery.Data.CardsByIDs.Card.self,
          CardBasicInfo.self,
          InnerCardInfo.self
        ] }
