...
public class ManaKit {
    ...
    public static let modelContainer: ModelContainer = {
        ...
        try! ModelContainer(for: SDSet.self,
                                 SDSetBlock.self,
                                 SDSetType.self)
    }()
    
//    public static let temporaryModelContainer: ModelContainer = {
...
//        copyModelFile()
    ...
    func copyDatabaseFile() {
        ...
        guard let bundleURL = bundle.resourceURL?.appendingPathComponent("ManaKit_ManaKit.bundle"), // local framework??
